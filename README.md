...
### Step-by-Step Configuration
  ...
  1. **Configuration Variables**: After completing the setup wizard, the solution will use two types of configuration:
     ...
     * `PLP_PRODUCTS_PER_PAGE`: Number of products to display per category listing page (default: `9`). Set to `0` to render category pages without any initial products or an `ItemList` in the JSON-LD.
